...
export function UserCell({ user }: { user: UserWithRoles }) {
  ...
  // Collect children names (if user is a parent)
  ...
  // Collect parent names (if user is a student)
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-col min-w-0 py-0.5">
        ...
        {/* Only show parents if student and not also a parent (avoid double display clutter) */}
